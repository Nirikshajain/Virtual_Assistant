...
def greet():
    ...
    SR.speak("\nMyself omega. How may I help you?")
    ...
    try:
        while(True):
            ...
            #asking for name
                ...
                SR.speak("My name is Omega and I'm here to serve you.")
            #How are you
            ...
            #who is searching mode
            elif there_exists(['who is','who the hell is','who is this'],query):
                query=query.replace("wikipedia","")
